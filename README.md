...
- **IEEE 754 Independence** — The `WasmFloat` typeclass abstracts over any IEEE 754 implementation via [ADR-001](docs/adr/001-typeclass-mediated-754-independence.md). Plug in your own float library.
...
| ADR | Decision |
|-----|----------|
| [ADR-001](docs/adr/001-typeclass-mediated-754-independence.md) | IEEE 754 independence via `WasmFloat` typeclass |
| [ADR-002](docs/adr/002-bitvec-universal-representation.md) | `BitVec N` as universal representation for all numeric types |
| [ADR-003](docs/adr/003-nondeterminism-as-sets.md) | Non-determinism modeled as `Set α` |
| [ADR-004](docs/adr/004-v128-shape-system.md) | V128 shape system for SIMD lane types |
| [ADR-005](docs/adr/005-flatmemory-parameterized-address-width.md) | `FlatMemory` parameterized by address width |
| [ADR-006](docs/adr/006-proof-separation.md) | Strict separation of definitions and proofs |
| [ADR-007](docs/adr/007-no-c-ffi.md) | No C FFI — pure Lean only |
