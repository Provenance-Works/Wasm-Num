...
本ドキュメントでは、wasm-num の全モジュール間のインポート関係を示します。
...
Proof モジュールは定義の階層構造を反映し、証明対象の定義モジュールと Mathlib のタクティクスの両方をインポートします:
...
- [English Version](../../en/architecture/module-dependency.md)
